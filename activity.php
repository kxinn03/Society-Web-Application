...
<html>
    ...
    <head>
        ...
        <title>Actitivity- TARUC Chinese Language Society</title>
...
<body>
    ...
    <h1>EVENT</h1>
        <p>Let's check out what events had organized by TARUC Chinese Language Society! Come and join our events!</p>
    </div>
    ...
    <?php
            $select = mysqli_query($conn, "SELECT * FROM activity ORDER BY ActID;");
    ?>
