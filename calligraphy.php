...
<html>
    <head>
        ...
        <title>Calligraphy - TARUC Chinese Language Society</title>
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    </head>
<body>

<div class="calligraphyheader">
  <h1>CALLIGRAPHY</h1>
  <p>Chinese calligraphy is the writing of Chinese characters as an art form, combining purely visual art and interpretation of the literary meaning.</p>
</div>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <?php
            $select = mysqli_query($conn, "SELECT * FROM activity WHERE Category='Calligraphy' ORDER BY ActID;");
    ?>
