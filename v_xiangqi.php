...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Xiangqi - TARUC Chinese Language Society</title>
...
<div class="xiangqiheader">
  <h1>XIANG QI</h1>
  <p>Xiangqi also called Chinese chess or elephant chess, is a strategy board game for two players.</p>
</div>
    ...
    <?php
            $select = mysqli_query($conn, "SELECT * FROM activity WHERE Category='Xiangqi' ORDER BY ActID;");
    ?>
