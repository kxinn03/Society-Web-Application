...
<html>
    ...
    <head>
        ...
        <title>Diabolo - TARUC Chinese Language Society</title>
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    </head>
<body>

<div class="diaboloheader">
  <h1>DIABOLO</h1>
  <p>A Diabolo – or Chinese yoyo, as they are sometimes referred to – is traditionally made of bamboo and wood. It is an empty roller, shaped like a dumbbell, which is spun and tossed on a string tied to two sticks, one held in each hand.</p>
</div>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <?php
            $select = mysqli_query($conn, "SELECT * FROM activity WHERE Category='Diabolo' ORDER BY ActID;");
    ?>
