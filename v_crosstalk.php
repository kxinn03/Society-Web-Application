...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Crosstalk - TARUC Chinese Language Society</title>
...
<div class="crosstalkheader">
  <h1>CROSSTALK</h1>
  <p>Crosstalk is a comedic monologue, dialogue, or multiplayer sketch that uses puns, allusions, and quick, playful banter.</p>
</div>
    ...
    <?php
            $select = mysqli_query($conn, "SELECT * FROM activity WHERE Category='Cross Talk' ORDER BY ActID;");
    ?>
